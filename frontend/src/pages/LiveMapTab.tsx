          ...
          <div className="bg-white/95 backdrop-blur-xl border border-blue-200/80 rounded-3xl p-4 sm:p-5 shadow-2xl text-slate-800 font-mono space-y-3.5 max-h-[calc(100vh-100px)] overflow-y-auto">
            ...
            <div className="flex items-center justify-between pb-2.5 border-b border-blue-100">
              ...
              <button
                ...
                className="flex items-center gap-1 px-2.5 py-1 rounded-xl bg-slate-100 hover:bg-rose-50 text-slate-600 hover:text-rose-600 text-[11px] font-bold border border-slate-200 hover:border-rose-200 transition-all cursor-pointer shadow-2xs active:scale-95"
                title="Close Pan-India Live Flood Monitoring Panel"
              >
